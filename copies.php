<!DOCTYPE html>
 ...
 <li class="active"><a href="copies.php">Copies</a></li>
 ...
 echo "<tr><td>".$row["CopyId"]."</td>"
 . "<td>".$row["DocId"]."</td>"
 . "<td>".$row["LibId"]."</td>"
 . "<td>".$row["CopyNo"]."</td>"
 . "<td>".$row["Position"]."</td>"
 . "<td><a href='deleteCopy.php?CopyId={$row['CopyId']}' style='color:#428bca;'>Delete</a></td>"
 ...
 <input class="form-control" placeholder="Copy Id" name="copyId" required = "true"> </br>

 <input class="form-control" placeholder="Document Id" name="docId" required = "true"></br>

 <input class="form-control" placeholder="Library Id" name="libId" required = "true"></br>

 <input class="form-control" placeholder="Copy Number" name="copyNo" required = "true"></br>

 <input class="form-control" placeholder="Position" name="position" required = "true"></br>


 <button class="btn btn-lg btn-primary btn-block" type="submit">Add Copy</button><br>
