<!DOCTYPE html>
 ...
 $DocId=$_GET['docId'];
 $query = "SELECT document.DocId, document.Title, author.AuthorName, journals.VolumeNo, journals.IssueNo, journals.CId, journals.GId, journals.Scope, libraryBranch.LibName, libraryBranch.Location "
