<!DOCTYPE html>
 ...
 $DocId=$_GET['docId'];
 $query = "SELECT document.DocId, document.Title, author.AuthorName,proceedings.CDate, proceedings.CLocation, proceedings.CChair, libraryBranch.LibName, libraryBranch.Location "
